...
class ClothingRemover:
    ...
    def generate_skin_tone(self, image: np.ndarray, 
        ...
        if gender == "male":
            ...
            skin_tone[0] = min(255, int(skin_tone[0] * 0.98))  
            skin_tone[1] = min(255, int(skin_tone[1] * 1.02))  
        elif gender == "female":
            
            skin_tone[0] = min(255, int(skin_tone[0] * 1.02))  
            skin_tone[2] = min(255, int(skin_tone[2] * 1.01))  
